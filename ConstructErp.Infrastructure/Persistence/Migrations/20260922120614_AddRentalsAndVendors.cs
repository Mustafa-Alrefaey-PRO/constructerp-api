...
{
    /// <inheritdoc />
    public partial class AddRentalsAndVendors : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedReturnOn = table.Column<DateOnly>(type: "date", nullable: false),
                    ReturnBookedOn = table.Column<DateOnly>(type: "date", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Rentals_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_ProjectId",
                table: "Rentals",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_ReturnedOn_ExpectedReturnOn",
                table: "Rentals",
                columns: new[] { "ReturnedOn", "ExpectedReturnOn" });

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_VendorId",
                table: "Rentals",
                column: "VendorId");
